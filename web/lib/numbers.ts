// Lifted from split-pro src/utils/numbers.ts (https://github.com/oss-apps/split-pro).
// Default currency changed from USD -> SGD; otherwise unchanged.
...
export const getCurrencyHelpers = ({
  ...
  currency = isCurrencyCode(currency) ? currency : 'SGD';
